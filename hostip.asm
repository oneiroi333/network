...
; esp+0x1C: ipv6_addr
	...
	mov ebx, [esp+0x50]								; grep function arg 'result' (info: return address at esp+0x4c)
...
.ipv4:
	...
	lea ebx, [ebx+sockaddr_in.sin_addr]				; get address of IPv4 address bytes
	mov [esp+0x4], ebx								; save it on stack esp+4: addr4
	lea ecx, [esp+0xC]								; addr of ipv4_addr
	push DWORD INET_ADDRSTRLEN
	push ecx
	push ebx
	push DWORD AF_INET
	call inet_ntop
...
.ipv6:
	...
	lea ecx, [esp+0x1C]								; addr of ipv6_addr
